...
class SavingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saving" do
    assert_difference('Saving.count') do
      post savings_url, params: { saving: { description: @saving.description, duration: @saving.duration, name: @saving.name } }
    end
  ...
  test "should update saving" do
    patch saving_url(@saving), params: { saving: { description: @saving.description, duration: @saving.duration, name: @saving.name } }
